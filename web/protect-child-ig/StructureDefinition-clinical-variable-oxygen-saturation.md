# Oxygen saturation - (DRAFT) PROTECT-CHILD Pediatric Transplant Data Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Oxygen saturation**

## Extension: Oxygen saturation 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/pc.ig|current/StructureDefinition/clinical-variable-oxygen-saturation)
...
Other representations of profile: [CSV](StructureDefinition-clinical-variable-oxygen-saturation.csv), [Excel](StructureDefinition-clinical-variable-oxygen-saturation.xlsx), [Schematron](StructureDefinition-clinical-variable-oxygen-saturation.sch) 
    ...
    "element" : [
      {
        ...
        "definition" : "Oxygen saturation at rest, in percent."
      },
      {
      ...
      },
      {
        "id" : "Extension.url",
        "path" : "Extension.url",
        "fixedUri" : "http://example.org/fhir/ImplementationGuide/donor-ig/StructureDefinition/clinical-variable-oxygen-saturation"
      },
      {
